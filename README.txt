...
'WooCommerce Sot By Stock' is a relatively simple plugin. It does one thing and one thing only: allows you to sort by stock amount in WooCommerce.
...
= Does this change the ordering of products on the frontend? =

No. This plugin only allows you to sort by stock amount on the dashboard (backend) of your site. This will not affect your frontend in any way.
